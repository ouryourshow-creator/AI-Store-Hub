  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-background" dir={dir}>
      ...
      <a
        ...
        aria-label="WhatsApp"
        className="fixed bottom-6 end-6 z-50 flex items-center gap-3 px-5 py-3 rounded-full bg-[#25D366] shadow-lg hover:bg-[#20c35e] hover:scale-105 active:scale-95 transition-all"
      >
