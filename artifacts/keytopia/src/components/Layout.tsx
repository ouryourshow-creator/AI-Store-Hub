  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-background" dir={dir}>
      <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-xl border-b border-black/[0.03]">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 select-none">
            <img src={logoImg} alt="Keytopia" className="h-20 w-auto object-contain" />
          </Link>
      ...
      <a
        ...
        aria-label="WhatsApp"
        className="fixed bottom-6 end-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-lg hover:bg-[#20c35e] hover:scale-110 active:scale-95 transition-all"
      >
        {/* WhatsApp SVG icon */}
